      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-center px-8 lg:px-24 bg-white z-10">
        <div className="w-full max-w-md">
          <div className="mb-10 text-center lg:text-left">
            <h2 className="text-4xl font-extrabold text-gray-900 tracking-tight mb-2">Login</h2>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div>
              ...
              <div className="relative">
                ...
                <input
                  type="email"
                  required
                  className="block w-full pl-10 pr-3 py-4 border-2 border-gray-100 rounded-xl leading-5 bg-gray-50 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent sm:text-sm transition-all font-medium"
            ...
            <button
              type="submit"
              className="w-full py-4 px-6 text-white bg-indigo-600 rounded-xl hover:bg-indigo-700 focus:outline-none focus:ring-4 focus:ring-indigo-200 transition-all font-bold text-lg shadow-lg shadow-indigo-100 flex items-center justify-center space-x-2"
            >
              <span>Sign In</span>
              <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-gray-500 font-medium">
              Need access? <span className="text-indigo-600 hover:underline cursor-pointer">Contact your administrator</span>
            </p>
          </div>
        </div>
      </div>
